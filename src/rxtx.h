...
unsigned send_chunk_from_db(MDB_env *env, MDB_dbi dbi, vs::cid_t start, vs::cid_t end, zmq::socket_t &s, vs::data_desc const &temp_desc /* template. */);
...
int send_one_720_from_db(uint8_t * buffer, size_t sz, zmq::socket_t &sender,
					 vs::data_desc const & cdesc, my_alloc_hint * hint);
int send_one_chunk_from_db(cv::Mat chunk[CHUNK_SIZE], size_t sz, zmq::socket_t &sender,
						   vs::data_desc const & desc, my_alloc_hint * hint);
